class AppConfig {
  ...
  static const String baseUrl = "http://192.168.15.62:8080";
  static const String baseWebSocketURL='ws://192.168.15.62:8080';
  ...
  static const String webSocketChatURL=baseUrl+'/chat?username=';
}
